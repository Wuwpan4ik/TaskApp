	...
	<div class="main">
		...
		<div class="form">
			...
			<div class="form__main">
				<form action="./vendor/login.php" class="main__form active" id="changeForm" method="POST">
				...
				<form action="./vendor/registration.php" class="main__form" id="changeForm" method="POST">
					<input name="login" class="form__input" placeholder="Введите логин">
					<input name="password" class="form__input" placeholder="Введите пароль">
